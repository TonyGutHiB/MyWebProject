...
<section class="team">
    ...
    <div class="team-grid"> <!-- Grid layout for team members -->
        <div class="team-member">
            <img src="../assets/images/tony.jpg" alt="Tony AbiAad - CEO"> <!-- Team member image -->
            <h3>Tony AbiAad</h3> <!-- Team member name -->
            <p>CEO & Founder</p> <!-- Team member role -->
        </div>
        <div class="team-member">
            <img src="../assets/images/adam.jpg" alt="Adam Hachem - Designer">
            <h3>Adam Hachem</h3>
            <p>Lead Designer</p>
        </div>
        <div class="team-member">
            <img src="../assets/images/elio.jpg" alt="Elio Chucri - Developer">
            <h3>Elio Chucri</h3>
            <p>Lead Developer</p>
        </div>
        <div class="team-member">
            <img src="../assets/images/majd.jpg" alt="Majd - Developer">
            <h3>Majd</h3>
            <p>Lead Developer</p>
        </div>
    </div>
